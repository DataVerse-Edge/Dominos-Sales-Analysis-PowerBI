...
Dataset
File: Dataset.csv
Granularity: One row per pizza line item (order line) with fields like:
order_id, pizza_name_id, pizza_name
quantity, price
order_date, order_time
pizza_category, pizza_ingredients
​
The data is cleaned and modeled in Power BI to support time intelligence and product-level analysis.
​
